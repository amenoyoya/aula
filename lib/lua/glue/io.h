...
namespace Aula {
    inline void registerIoLibrary(sol::state &lua) {
        ...
        io.new_usertype<IO::Binary>(
            ...
            "getCRC32", sol::overload(
                [](const void *buffer, u32 bufferlen, u32 crc32_start) { return IO::Binary::getCRC32(buffer, bufferlen, crc32_start); },
                [](const void *buffer, u32 bufferlen) { return IO::Binary::getCRC32(buffer, bufferlen); }
            )
        );
